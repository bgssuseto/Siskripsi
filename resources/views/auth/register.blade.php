<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-slate-100 tracking-tight">Buat Akun Baru</h2>
        <p class="mt-2 text-gray-500 dark:text-slate-400">Daftar untuk bergabung dengan Skripsi TI</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Nama Lengkap</label>
            <div class="relative">
        ...
        <div>
            <label for="nim" class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">NIM Mahasiswa <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-gray-400 dark:text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input id="nim" name="nim" type="text" value="{{ old('nim') }}" required autocomplete="off"
                    class="block w-full pl-12 pr-4 py-3.5 bg-slate-100 dark:bg-slate-800 border border-transparent rounded-xl text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:bg-white dark:focus:bg-slate-900 focus:border-indigo-500 transition-all duration-200 @error('nim') bg-red-50 dark:bg-red-950/40 focus:border-red-500 focus:ring-red-500/20 @enderror"
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Konfirmasi Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-gray-400 dark:text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <p class="text-center text-gray-600 dark:text-slate-400">
        Sudah punya akun?
        <a href="{{ route('login') }}" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">
            Masuk sekarang
        </a>
    </p>
