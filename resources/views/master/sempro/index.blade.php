<x-app-layout title="Data Sempro">
    ...
    <div class="data-page space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Data Sempro</h1>
                <p class="text-sm text-slate-500 mt-1">Kelola data mahasiswa seminar proposal (sempro).</p>
            </div>
                        ...
                        @forelse ($sidangs as $item)
                            <tr>
                                ...
                                <td class="text-right space-x-1 whitespace-nowrap">
                                    ...
                                    <form method="POST" action="{{ route('master.sempro.destroy', $item->id) }}" style="display:inline;"
                                          onsubmit="return confirm('Hapus data sempro ini?')">
                                        @csrf @method('DELETE')
    ...
    <script>
        ...
        function openEdit(id, data) {
            const base = '{{ url("master/sempro") }}/' + id;
