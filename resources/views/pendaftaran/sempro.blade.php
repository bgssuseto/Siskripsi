    ...
    <div x-show="previewModal" x-cloak 
        ...
        <div @click.away="previewModal = false" class="bg-white dark:bg-slate-900 rounded-3xl max-w-4xl w-full p-6 text-slate-800 dark:text-slate-100 shadow-2xl overflow-hidden relative border border-slate-100 dark:border-slate-800 space-y-4">
            ...
            <div class="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <a :href="previewUrl" download target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 dark:bg-indigo-950/50 hover:bg-indigo-100 text-indigo-700 dark:text-indigo-300 font-extrabold text-xs rounded-xl border border-indigo-200 dark:border-indigo-900 transition-all">
                    📥 Unduh File Asli
                </a>
